...
class ModoAcaoUseCaseUpdateTest {
    ...
    void testUpdateWithEmptyNameException() throws ValidationException {
        assertAll(
                () -> assertThrows(WithNameEmptyException.class, () -> grupoUseCase.update(new ModoAcaoDTO(1, ""))),
    ...
    void testUpdateWithNameMaxCharacterException() throws ValidationException {
        assertThrows(WithNameMaxSizeException.class,
                () -> grupoUseCase.update(new ModoAcaoDTO(1, "a".repeat(51))));
    }
    ...
    void testUpdateWithIdZeroOrNotInformedException() throws ValidationException {
        ...
        ModoAcaoDTO grupo = new ModoAcaoDTO();
    ...
    void testUpdateWithNameAlreadInformedException() throws ValidationException {
        ...
        when(grupoRepository.save(any(ModoAcao.class))).thenThrow(WithNameAlreadInformedException.class);
        assertThrows(WithNameAlreadInformedException.class,
                () -> {
                    grupoUseCase.insert(new ModoAcaoDTO(1, "TestGroup First"));
                    grupoUseCase.insert(new ModoAcaoDTO(2, "TestGroup Seconde"));
                    grupoUseCase.update(new ModoAcaoDTO(1, "TestGroup Second"));
                });
    }
    ...
    void testUpdateWithNonEmptyName() throws ValidationException {
        ModoAcaoDTO grupoDTO = new ModoAcaoDTO(0, "testUpdateWithNonEmptyName");
