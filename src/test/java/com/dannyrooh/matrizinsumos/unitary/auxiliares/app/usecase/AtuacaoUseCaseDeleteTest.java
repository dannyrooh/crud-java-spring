...
class AtuacaoUseCaseDeleteTest {
    ...
    void testDeleteIdNotOrZeroInformedException() throws ValidationException {
        assertThrows(WithIdZeroOrNotInformedException.class,
                () -> atuacaoUseCase.delete(0));
        assertThrows(WithIdZeroOrNotInformedException.class,
                () -> atuacaoUseCase.delete(-1));
    }
    ...
    void testDeleted() throws ValidationException {
        ...
        doNothing().when(atuacaoRepository).deleteById(1);
        when(atuacaoRepository.existsById(1)).thenReturn(Boolean.valueOf(true));
