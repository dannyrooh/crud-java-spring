...
class EpocaAplicacaoRestControllerTest {
    ...
    @Mock
    private EpocaAplicacaoUseCase grupoUseCase;

    @InjectMocks
    private EpocaAplicacaoRestController grupoRestController;
    ...
    void testInsert() throws Exception {
        EpocaAplicacaoDTO grupoDTO = new EpocaAplicacaoDTO(1, "Test Group");

        when(grupoUseCase.insert(any(EpocaAplicacaoDTO.class))).thenReturn(grupoDTO);
    ...
    void testUpdate() throws Exception {
        EpocaAplicacaoDTO grupoDTOToUpdate = new EpocaAplicacaoDTO(1, "Updated Group");

        when(grupoUseCase.update(any(EpocaAplicacaoDTO.class))).thenReturn(grupoDTOToUpdate);
    ...
    void testGetById() throws Exception {
        int idToGet = 1;
        EpocaAplicacaoDTO grupoDTO = new EpocaAplicacaoDTO(idToGet, "Test Group");
    ...
    void testGetAll() throws Exception {
        List<EpocaAplicacaoDTO> grupoDTOList = Arrays.asList(
                new EpocaAplicacaoDTO(1, "Group 1"),
                new EpocaAplicacaoDTO(2, "Group 2"),
                new EpocaAplicacaoDTO(3, "Group 3"));
