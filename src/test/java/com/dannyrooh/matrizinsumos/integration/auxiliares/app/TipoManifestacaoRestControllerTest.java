...
class TipoManifestacaoRestControllerTest {
    ...
    @Mock
    private TipoManifestacaoUseCase grupoUseCase;

    @InjectMocks
    private TipoManifestacaoRestController grupoRestController;
    ...
    void testInsert() throws Exception {
        TipoManifestacaoDTO grupoDTO = new TipoManifestacaoDTO(1, "Test Group");

        when(grupoUseCase.insert(any(TipoManifestacaoDTO.class))).thenReturn(grupoDTO);
    ...
    void testUpdate() throws Exception {
        TipoManifestacaoDTO grupoDTOToUpdate = new TipoManifestacaoDTO(1, "Updated Group");

        when(grupoUseCase.update(any(TipoManifestacaoDTO.class))).thenReturn(grupoDTOToUpdate);
    ...
    void testGetById() throws Exception {
        int idToGet = 1;
        TipoManifestacaoDTO grupoDTO = new TipoManifestacaoDTO(idToGet, "Test Group");
    ...
    void testGetAll() throws Exception {
        List<TipoManifestacaoDTO> grupoDTOList = Arrays.asList(
                new TipoManifestacaoDTO(1, "Group 1"),
                new TipoManifestacaoDTO(2, "Group 2"),
                new TipoManifestacaoDTO(3, "Group 3"));
