...
class TipoInfluenciaSoloRestControllerTest {
    ...
    @Mock
    private TipoInfluenciaSoloUseCase grupoUseCase;

    @InjectMocks
    private TipoInfluenciaSoloRestController grupoRestController;
    ...
    void testInsert() throws Exception {
        TipoInfluenciaSoloDTO grupoDTO = new TipoInfluenciaSoloDTO(1, "Test Group");

        when(grupoUseCase.insert(any(TipoInfluenciaSoloDTO.class))).thenReturn(grupoDTO);
    ...
    void testUpdate() throws Exception {
        TipoInfluenciaSoloDTO grupoDTOToUpdate = new TipoInfluenciaSoloDTO(1, "Updated Group");

        when(grupoUseCase.update(any(TipoInfluenciaSoloDTO.class))).thenReturn(grupoDTOToUpdate);
    ...
    void testGetById() throws Exception {
        int idToGet = 1;
        TipoInfluenciaSoloDTO grupoDTO = new TipoInfluenciaSoloDTO(idToGet, "Test Group");
    ...
    void testGetAll() throws Exception {
        List<TipoInfluenciaSoloDTO> grupoDTOList = Arrays.asList(
                new TipoInfluenciaSoloDTO(1, "Group 1"),
                new TipoInfluenciaSoloDTO(2, "Group 2"),
                new TipoInfluenciaSoloDTO(3, "Group 3"));
