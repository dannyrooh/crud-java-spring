...
import com.dannyrooh.matrizinsumos.auxiliares.domain.validate.NivelPericulosidadeUseCaseValidade;
import com.dannyrooh.matrizinsumos.exception.WithIdZeroOrNotInformedException;
import com.dannyrooh.matrizinsumos.exception.WithNameEmptyException;
import com.dannyrooh.matrizinsumos.exception.WithNameMaxSizeException;

@Component
public class NivelPericulosidadeUseCaseValidateImpl implements NivelPericulosidadeUseCaseValidade {

    private void validateName(NivelPericulosidadeDTO grupoDTO, Integer size) {
