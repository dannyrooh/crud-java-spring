...
import com.dannyrooh.matrizinsumos.auxiliares.domain.validate.TipoRiscoPotencialUseCaseValidade;
import com.dannyrooh.matrizinsumos.exception.WithIdZeroOrNotInformedException;
import com.dannyrooh.matrizinsumos.exception.WithNameEmptyException;
import com.dannyrooh.matrizinsumos.exception.WithNameMaxSizeException;

@Component
public class TipoRiscoPotencialUseCaseValidateImpl implements TipoRiscoPotencialUseCaseValidade {

    private void validateName(TipoRiscoPotencialDTO grupoDTO, Integer size) {
