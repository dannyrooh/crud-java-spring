...
import com.dannyrooh.matrizinsumos.auxiliares.domain.validate.EpocaAplicacaoUseCaseValidade;
import com.dannyrooh.matrizinsumos.exception.WithIdZeroOrNotInformedException;
import com.dannyrooh.matrizinsumos.exception.WithNameEmptyException;
import com.dannyrooh.matrizinsumos.exception.WithNameMaxSizeException;

@Component
public class EpocaAplicacaoUseCaseValidateImpl implements EpocaAplicacaoUseCaseValidade {

    private void validateName(EpocaAplicacaoDTO grupoDTO, Integer size) {
