...
import com.dannyrooh.matrizinsumos.auxiliares.domain.validate.InformacaoAdicionalDaninhaUseCaseValidade;
import com.dannyrooh.matrizinsumos.exception.WithIdZeroOrNotInformedException;
import com.dannyrooh.matrizinsumos.exception.WithNameEmptyException;
import com.dannyrooh.matrizinsumos.exception.WithNameMaxSizeException;

@Component
public class InformacaoAdicionalDaninhaUseCaseValidateImpl implements InformacaoAdicionalDaninhaUseCaseValidade {

    private void validateName(InformacaoAdicionalDaninhaDTO grupoDTO, Integer size) {
